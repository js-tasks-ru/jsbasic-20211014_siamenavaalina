function highlight(table) {
	let status = document.querySelectorAll('tbody tr > td:last-child');
	for(let i = 0; i < status.length; i++){
		...
		let gender = document.querySelectorAll('tbody tr > td:nth-child(3)');
		...
		let age = document.querySelectorAll('tbody tr > td:nth-child(2)');
